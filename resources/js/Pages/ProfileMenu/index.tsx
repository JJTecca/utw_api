 ...
 ****************************************************************************************************/
/****************************************************************************************************
 * 1. Displays the user’s aviation profile with sections for payments, reports, ratings, and progress.
 * 2. Toggles an extended dashboard layout dynamically to show detailed accordions and performance data.
 * 3. Provides an interactive interface for reviewing flight experiences, viewing status, and tracking activity.
 ****************************************************************************************************/
